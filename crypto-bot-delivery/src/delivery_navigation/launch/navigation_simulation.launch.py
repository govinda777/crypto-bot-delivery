...
def generate_launch_description():
    ...
    initial_pose_x_arg = DeclareLaunchArgument(
        "initial_pose_x",
        default_value="0.0",
        description="Initial X pose for the robot",
    )
    initial_pose_y_arg = DeclareLaunchArgument(
        "initial_pose_y",
        default_value="0.0",
        description="Initial Y pose for the robot",
    )
    initial_pose_yaw_arg = DeclareLaunchArgument(
        "initial_pose_yaw",
        default_value="0.0",
        description="Initial Yaw pose for the robot",
    )
    ...
    initial_pose_x = LaunchConfiguration(
        "initial_pose_x"
    )  # Not directly used in this version but declared
